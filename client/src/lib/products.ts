...
export const BRAND_INFO: Record<string, { country: string; description: string; website?: string }> = {
  ...
  "Canmak": {
    ...
    description: "Jérôme François and Morgane Stoquert produce atypical wines from Alsace with great character. Installed in Ostheim since 2014 — after a life as a carpenter — Jérôme started his domaine from a few plots and an old barn belonging to his great uncle Charles, paying tribute in the name of the estate. His mentor, the famous Alsacian Marcel Deiss, had a lasting influence on his philosophy and vision of viticulture. Following biodynamic principles, the couple works with Sirus and Fastoche, two horses ploughing the vineyards, alongside a pack of black sheep for natural grazing. The entirety of the 7-hectare vineyard is co-planted with old, middle-aged and young vines on a diversity of soils — a sensitive approach to the fruits, the vines, and the whole ecosystem, resulting in wines of elegance with their own subtle touch.\n\nJérôme François 和 Morgane Stoquert 在阿爾薩斯 Ostheim 釀造個性獨特的葡萄酒。Jérôme 曾以木匠為業，2014 年以舊日大伯 Charles 的穀倉為起點，向恩師、阿爾薩斯名釀 Marcel Deiss 取法，走上生物動力農法之路。兩匹馬 Sirus 和 Fastoche 犁地，一群黑羊自然除草，7 公頃葡萄園混植不同樹齡的老藤，多元土壤孕育出優雅而個性鮮明的酒款。",
  },
  "Maison A&S": {
    country: "France · Burgundy",
    description: "Maison A&S was established in 2018 by Pierre-Alexandre Soltana and Alexandre Aires — two young winemakers and longtime friends from Burgundy — with the vision of building a high-quality micro-négoce, from grape sourcing to élevage. They began in a rented 17th-century vaulted cellar in Chagny, crafting their first three vintages. In 2021, they acquired a winery and plots around Nantoux and Pommard in the Hautes Côtes de Beaune, focusing on Pinot Noir, Chardonnay and Aligoté. Pierre-Alexandre is currently head of viticulture at Domaine des Comtes Lafon, while Alexandre is cellar master at Domaine Thibault Liger-Belair. Respecting Burgundy tradition while bringing a modern eye, Maison A&S is a duo to watch.\n\nMaison A&S 由 Pierre-Alexandre Soltana 與 Alexandre Aires 兩位 Burgundy 老友於 2018 年創立，專注高品質微型酒商（micro-négoce）。他們從租用的 17 世紀酒窖起步，2021 年於 Nantoux 及 Pommard 附近置地建窖，深耕 Pinot Noir、Chardonnay 及 Aligoté。Pierre-Alexandre 現任 Domaine des Comtes Lafon 首席農藝師，Alexandre 任 Domaine Thibault Liger-Belair 首席釀酒師，傳統與現代兼融，是 Burgundy 最值得關注的新星組合。",
    website: "https://www.maison-as.fr",
  },
  "Domaine La Grapp'A": {
    country: "France · Jura",
    description: "Aurélie Parla and Julien Maublanc created Domaine La Grapp'A and worked their first vintage in 2021. Both from Jura, the 5-hectare vineyard has been in Julien's family for generations, farmed organically for the local cooperative. Located in Abergement-le-Grand, just 5km outside Arbois, the estate is planted with old massale selections of Chardonnay, Savagnin (yellow and green), Pinot Noir and the local reds Trousseau and Poulsard. While converting to biodynamic viticulture, Aurélie and Julien are also planting 2.5 hectares of young vines. In the cellar, they are precise and careful, exploring different maceration times and ageing their whites in a historic 16th-century limestone cellar.\n\nAurélie Parla 與 Julien Maublanc 於 2021 年創立 Domaine La Grapp'A。Jura 本地人，5 公頃葡萄園傳承自 Julien 家族，有機耕作多年。酒莊位於 Arbois 附近的 Abergement-le-Grand，種有老藤的 Chardonnay、Savagnin、Pinot Noir 及 Jura 特有的 Trousseau 和 Poulsard，同時進行生物動力農法轉換。白酒在 16 世紀石灰岩地窖中陳年，是 Jura 最受矚目的新生代酒莊之一。",
  },
  "Jean-Baptiste Hardy": {
    country: "France · Loire (Muscadet)",
    description: "Trained with Jean-Marc Roulot and Domaine Leflaive, and having worked in vineyards across Patagonia (Bodega Chacra), California (Domaine de la Côte) and New Zealand (Fromm Winery), Jean-Baptiste took over his family estate in Mouzillon, Muscadet-Sèvre-et-Maine in 2018. He has converted 8.5 hectares to biodynamic culture, planted exclusively with local varieties on massale selections from the 1950s and 1960s. The terroir — complex gabbro volcanic soils, silica and clay — gives a minerality and precision rarely associated with Muscadet. His first vintage was 2020, and he is already one of the most exciting names in the Loire.\n\nJean-Baptiste 師承 Jean-Marc Roulot 與 Domaine Leflaive，曾赴阿根廷、加州和新西蘭釀酒，2018 年回鄉接管家族在 Mouzillon（Muscadet Sèvre et Maine）的酒莊。8.5 公頃葡萄園全面轉為生物動力農法，種有 1950、60 年代種植的老藤 Melon de Bourgogne。玄武岩、矽石與黏土交雜的複雜土壤，賦予酒款媲美 Chablis 的礦物感與精準度。2020 年首個年份即備受矚目，是羅亞爾河谷最令人期待的新名字。",
  },
  "Domaine Les Aricoques": {
    country: "France · Savoie (Haute-Savoie)",
    description: "Since 2021, friends Romain Dupont and Guillaume Bellon have taken over a 4.8-hectare estate in the mountain village of Frangy, Haute-Savoie. Passionate about their roots and terroir, they farm local varieties — Altesse, Roussette, Jacquère, Mondeuse and Gamay — on the estate's signature moraine glacière soils: a very poor glacial substrate that produces low yields of exceptional concentration. At 500 metres altitude with southern exposure, the combination is ideal for wine growing. The name 'Pan!' pays homage to the village — the locals are called Frangypans — and echoes the satisfying sound of a cork being pulled. Les Aricoques is already one of the most exciting discoveries in Savoie.\n\nRomain Dupont 與 Guillaume Bellon 兩位好友自 2021 年起接管薩瓦省 Frangy 的 4.8 公頃酒莊。冰磧土（Moraine Glacière）是酒莊的靈魂——這種極度貧瘠的冰川土壤造就低產量與高度集中的果實。海拔 500 米南向山坡，種植當地品種 Altesse、Roussette、Jacquère、Mondeuse 和 Gamay。酒款以「Pan!」命名，致敬 Frangy 村民（Frangypans），也象徵開瓶時那令人愉悅的清脆聲響。",
  },
  "Maison Pommier": {
    country: "France · Burgundy (Irancy)",
    description: "Isabelle and Denis Pommier are among Chablis' most respected organic producers. Based in Poinchy, the domaine farms certified organic vineyards in Chablis and the nearby Irancy appellation, where Pinot Noir thrives on the steep limestone slopes north of Auxerre. Their approach is gentle and precise — natural yeasts, minimal intervention, and long élevage that allows each terroir to speak clearly. The Irancy is a rare expression of Burgundy's most northerly red wine appellation: structured, mineral and built to age.\n\nIsabelle 與 Denis Pommier 是夏布利最受尊崇的有機酒農之一。酒莊位於 Poinchy，在夏布利及鄰近的 Irancy 法定產區耕作，後者是 Burgundy 最北端的紅酒產區，Pinot Noir 生長於 Auxerre 北面的石灰岩陡坡上。他們以天然酵母、低干預和長期陳年的方式，讓每塊風土清晰表達——Irancy 結構感強、礦物感突出，具極佳陳年潛力。",
  },
  "Domaine 7": {
    country: "France · Loire (Anjou)",
    description: "Abel Benmaamar farms certified organic vines on schist soils in Martigné-Briand, in the heart of Anjou. Working with indigenous yeasts, minimal sulphur and gentle winemaking, his wines are vivid expressions of Anjou's two great varieties: Cabernet Franc for reds and Chenin Blanc for whites. The schist terroir brings a vibrant mineral backbone and freshness that makes his wines some of the most precise and energetic natural wines in the Loire today.\n\nAbel Benmaamar 在安茹 Martigné-Briand 的頁岩上以有機農法種植葡萄，採用天然酵母、少量二氧化硫，釀造安茹最具代表性的兩個品種：Cabernet Franc 紅酒與 Chenin Blanc 白酒。頁岩風土賦予酒款鮮活的礦物骨幹與清爽活力，是羅亞爾河最精準動人的自然酒之一。",
  },
  "Chateau Mihope": {
    country: "China · Ningxia · 美賀莊園",
    description: "Chateau Mihope (美賀莊園) is located at the eastern foothills of the Helan Mountain in Ningxia, one of China's premier wine regions. The chateau combines a stately French classical exterior with the dramatic backdrop of the Helan range, producing wines that reflect the unique terroir of China's arid northwest. With over 1,000 hours of annual sunshine, significant diurnal temperature variation, and loess alluvial soils, Ningxia delivers grapes of exceptional concentration and natural acidity. Chateau Mihope crafts a diverse range spanning Cabernet Sauvignon blends, pure-varietal Syrah, Marselan and Cabernet Gernischt reds, alongside Chardonnay, Viognier and Riesling whites — a comprehensive portrait of China's most exciting wine region.\n\n美賀莊園坐落於寧夏賀蘭山東麓，是中國最重要的葡萄酒產區之一。莊園以典雅的法式城堡外觀呼應賀蘭山的雄偉背景，出產的葡萄酒充分展現中國西北獨特的風土。年均光照逾1,000小時，晝夜溫差顯著，黃土沖積層土壤賦予葡萄卓越的濃縮度與天然酸度。美賀莊園出品的酒款涵蓋赤霞珠混釀、純品種西拉、馬瑟蘭及品麗珠紅酒，以及霞多麗、維歐尼耶和雷司令白酒，是中國最令人振奮的葡萄酒產區的全面呈現。",
    website: "https://www.mihope.com",
  },
  "La Manufacture": {
