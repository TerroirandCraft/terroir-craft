...
// Always use Railway URL for payment callbacks — custom domain apex (no www) is unreliable
// Railway URL never has www/non-www issues
const BASE_URL = "https://terroir-craft-production.up.railway.app";
